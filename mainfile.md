...
First, we conduct the logistic regression. We present a plot of variable importance followed by the
confusion matrix generated after the model was tested.

![](figure-gfm/unnamed-chunk-7-1.png)<!-- -->

*Figure 3. Variable Importance Plot from Logistic Model*

![](figure-gfm/unnamed-chunk-8-1.png)<!-- -->

*Figure 4. Confusion Matrix for Logistic Model Predictions*
